...
**aprendes** és un repositori de materials acadèmics de matemàtiques per a Batxillerat i Universitat.
...
El repositori s’organitza en dos grans nivells:
...
Cada nivell conté materials organitzats per àrees matemàtiques.
...
Abans d’enviar una contribució, és recomanable revisar les instruccions específiques de cada carpeta, especialment els fitxers `README.md` i `CONTRIBUTING.md` que hi pugui haver dins de cada nivell o document.

## Estat del projecte

El projecte està en desenvolupament.

Alguns materials poden estar en fase d’esborrany, revisió o ampliació. Per això, les aportacions d’alumnes i professors són especialment valuoses.

## Llicència

La llicència del projecte s’indicarà en aquest repositori.

Fins que no s’especifiqui una llicència concreta, cal demanar autorització abans de reutilitzar, redistribuir o modificar substancialment els materials fora del marc de col·laboració del repositori.

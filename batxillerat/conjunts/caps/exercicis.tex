...
Sabem que 12 persones sol·liciten pla\c{c}a
d'electricista, 12 de mec\`{a}nic, 15 de fuster, 3 d'electricista i mec\`{a}%
nic, 4 de mec\`{a}nic i fuster, 5 d'electricista i fuster i, finalment, 1 sol·licita pla\c{c}a de les tres coses. Calcula quanta
...
\item Comprova si les seg\"{u}ents col·leccions de
...
\item[b)] \textquotedblleft Ser equipol·lent\textquotedblright\ en el conjunt dels vectors fixos del pla

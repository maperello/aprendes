...
\begin{indicacio}
$A\cap B$ és el conjunt de múltiples de 6, $C\cup
...
\begin{indicacio}
a) $U$, b) $A$, c) $A\cap (B\cup C)$ i d) $A\cup C$
\end{indicacio}
...
\item
\begin{exercici}
Una empresa ofereix places d'electricista, de mecànic i de fuster.
...
\item
\begin{exercici}
En una reunió hi ha 25 persones que són mèdics, músics
...
\item
\begin{exercici}
D'un grup de 1000 persones, 950 porten rellotge, 750 porten paraigua,
...
\item
\begin{exercici}
Comprova si les següents col·leccions de
...
\item
\begin{exercici}
Quina relació binària sobre un conjunt és simètrica i
antisimètrica?
\end{exercici}
...
\item
\begin{exercici}
De les següents relacions, quines són d'equivalència? I en
...
\begin{indicacio}
(a) És d'equivalència i els alumnes queden classificats
...
\begin{indicacio}
Observa que $x\sim y$ si i només si existeix un nombre
...
\item
\begin{exercici}
Esbrina si la relació «$x$ divideix $y$%
...
\begin{indicacio}
(a) És d'ordre parcial, $1$ és minimal i no hi ha
elements maximals. (b) No és d'ordre
\end{indicacio}

\item
\begin{exercici}
En el conjunt dels nombres reals ordenat segons la relació d'ordre
...
\begin{indicacio}
(a) $\min A=\inf A=1$ i $\max A=\sup A=5$, (b) $\inf B=-2$ i $
...
\begin{indicacio}
(a) És d'ordre parcial (b) No existeixen $\max B$, $\min B$%
...
\item
\begin{exercici}
Es donen els conjunts $A=\{2,3,4,7,8\}$ i $B=\{1,2,3,4,5,7,9\}$. Sigui
...
\begin{indicacio}
És una aplicació injectiva
\end{indicacio}

\item
\begin{exercici}
Donades les aplicacions $f:\mathbb{R}~\longrightarrow ~\mathbb{R}$
...
\begin{indicacio}
(a) $f$ és injectiva però no exhaustiva i $g$ és
...
\item
\begin{exercici}
Sigui $f:\mathbb{R}-\{1\}~\longrightarrow ~\mathbb{R}-\{3\}$ definida
per%
\begin{equation*}
f(x)=\frac{3x-1}{x-1}
\end{equation*}%
...
\begin{indicacio}
Cal demostrar que és injectiva i exhaustiva. L'aplicació
inversa és%
\begin{equation*}
f^{-1}(x)=\frac{x-1}{x-3}
\end{equation*}

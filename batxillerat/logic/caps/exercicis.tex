...
\item Si el quadrat d'un nombre enter no \'{e}s divisible per 4, aleshores
...
valors seg\"{u}ents (1) $x=3,y=1$; (2) $x=1,y=2$.
...
$ \'{e}s de la forma $8k+1$, per a algun enter $k\geq0$.

\item Demostreu directament que les solucions reals de l'equaci\'{o} $ax^{2}+bx+c=0
$, on $a,b,c\in\mathbb{R}$, $a\neq0$ i $b^{2}-4ac\geq0$, s\'{o}n expressades per la
f\'{o}rmula
\[
...
\item Proveu per reducci\'{o} a l'absurd que hi ha infinits nombres primers.

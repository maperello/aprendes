...
\mathbb{Z}$, $\mathbb{Q}$ o $\mathbb{R}$ dels següents nombres:%
\[
...
\begin{exercici}
Dels següents nombres reals, després d’efectuar les
...
\begin{exercici}
Ordena de menor a major els següents nombres reals:%
\[
\begin{array}{cccccc}
...
\end{array}%
\]%
i, després, ordrea’ls de menor a major.
...
\begin{exercici}
Troba una successió d’intervals encaixats que determini cadascun dels següents nombres reals: (a) $2.757575...$ (b) $%
3.2484848...$ i (c) $\pi $.
...
\begin{exercici}
Troba el suprem i l’ínfim dels següents subconjunts de nombres reals, indicant si són màxim o mínim respectivament.
...
\begin{exercici}
Expressa en forma d’intervals els següents conjunts:
...
\begin{exercici}
Expressa en forma d’entorns els següents intervals%
\[
\begin{array}{cccccc}
a) & (-1,5) & b) & (0,3) & c) & (8,12)%
\end{array}%

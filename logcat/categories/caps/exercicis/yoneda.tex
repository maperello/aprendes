...
\begin{exercici}
Fes servir el lema de Yoneda per calcular $\Nat(\Hom(-,A),\Hom(-,B))$ i comprova que la bijecció resultant és precisament l'acció de la immersió de Yoneda sobre els morfismes $A\to B$. \hfill{\normalfont$\star\star$}
\begin{indicacio}
...
\begin{exercici}
Comprova que la immersió de Yoneda $\yon\colon\cat{C}\to\cat{Set}^{\cat{C}\op}$ \emph{no} és, en general, essencialment exhaustiva, tot i ser plena i fidel. Quins prefeixos són de la forma $\Hom(-,A)$? \hfill{\normalfont$\star\star$}
\begin{indicacio}

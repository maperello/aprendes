...
\begin{exercici}
Comprova que la injecció dels oberts $i\colon\mathcal O(X)\to\mathcal P(X)$ té com a adjunt per la dreta l'interior, i digues quina propietat universal expressa.
\end{exercici}

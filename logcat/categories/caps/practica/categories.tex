...
Pel que fa a mono i epi: com que $f$ té una secció, $f$ és un epimorfisme (i, a $\cat{Set}$, és exhaustiva). Com que $g$ té una retracció, $g$ és un monomorfisme (i és injectiva). En canvi $f$ no és mono ---no és injectiva, ja que $f(0)=f(1)$--- i $g$ no és epi ---no és exhaustiva, ja que $1\notin g(\{\ast\})$. Cap dels dos és un isomorfisme: ho serien només si $g\comp f$ fos també una identitat, cosa que hem vist que no passa.
\end{solucio}

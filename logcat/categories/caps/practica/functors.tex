...
Quant a la \textbf{plenitud}: $J$ seria ple si, per a cada parella de fórmules $A,B$, tota fletxa $J(A)\to J(B)$ a $\cat{Prov}_{T'}$ provingués d'una fletxa $A\to B$ a $\cat{Prov}_T$. És a dir, si
\[

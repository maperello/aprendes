...
\item La inclusió $f\colon\{0\}\hookrightarrow\{0,1\}$ té una única retracció, l'única aplicació $\{0,1\}\to\{0\}$; en canvi no té cap secció.
...
separadament, no caracteritza els isomorfismes en una categoria general; per exemple, la inclusió
\[
...
\item[(2)] \textbf{mono escindit $\not\Rightarrow$ iso.} Un monomorfisme escindit no ha de ser exhaustiu en cap sentit: a $\cat{Set}$, la inclusió $\{0\}\hookrightarrow\{0,1\}$ té retracció (l'única aplicació $\{0,1\}\to\{0\}$), és per tant un monomorfisme escindit, però no és un isomorfisme.
\end{itemize}

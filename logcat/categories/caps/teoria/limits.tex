...
\begin{exemple}
A $\cat{Set}$, l'equalitzador de $f,g\colon A\to B$ és el subconjunt $E=\{a\in A\mid f(a)=g(a)\}$ amb la inclusió. En general, els equalitzadors representen els subobjectes definits per una equació. Tot equalitzador és un monomorfisme.
\end{exemple}
...
\begin{exemple}
A $\cat{Set}$, el pullback és $P=\{(a,b)\in A\times B\mid f(a)=g(b)\}$ amb les projeccions. Quan $g\colon B\hookrightarrow C$ és la inclusió d'un subconjunt, el pullback recupera l'antiimatge $f^{-1}(B)$; per això el pullback també s'anomena \emph{imatge inversa} o \emph{producte fibrat}, i s'escriu $A\times_C B$.
\end{exemple}

...
\begin{observacio}
A $\cat{Set}$, $\Imatge(f)$ és el subconjunt imatge $f(A)\subseteq B$, amb $e$ l'aplicació exhaustiva $A\to f(A)$ i $m$ la inclusió. Recuperem la noció usual d'imatge.
\end{observacio}

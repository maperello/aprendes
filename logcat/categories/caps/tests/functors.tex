...
Aquest test no busca que recordis definicions, sinó que \emph{raonis} amb elles: decidir què preserva o reflecteix un functor, trobar l'error d'un argument i aplicar les nocions de ple, fidel i essencialment exhaustiu a casos concrets. Cada pregunta té una única resposta correcta; abans de triar, intenta justificar-la tu mateix.
...
\begin{enumerate}
  \opcio{a}{Res: la plenitud i fidelitat no diuen res sobre isomorfismes.}

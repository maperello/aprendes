...
Aquest test no busca que recordis definicions, sinó que \emph{raonis} amb elles: decidir si una família concreta és natural, trobar l'error d'un argument, aplicar el teorema de caracterització a un cas i distingir nocions properes. Cada pregunta té una única resposta correcta; abans de triar, intenta justificar-la tu mateix.
...
\begin{enumerate}
  ...
  \opcio{b}{No: essencialment exhaustiu només demana que tot objecte de $\cat{D}$ sigui \emph{isomorf} a una imatge, i la plenitud i la fidelitat afecten els morfismes, no la injectivitat sobre objectes; $F$ pot no ser bijectiu sobre objectes (per exemple la inclusió d'un esquelet).}
...
\begin{enumerate}
  ...
  \opcio{b}{Només la fidelitat.}
  \opcio{c}{Que $F$ sigui ple i fidel: la plenitud dona l'existència de $G(v)$ i la fidelitat, la unicitat.}

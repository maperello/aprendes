...
\pregunta Què és el \textbf{plançó de Yoneda}?
\begin{enumerate}
...
\pregunta Una conseqüència directa del lema de Yoneda és que el plançó $\yon$ és:
\begin{enumerate}
  \opcio{a}{constant.}
  \opcio{b}{ple i fidel.}
  \opcio{c}{essencialment exhaustiu.}
...
\pregunta El plançó de Yoneda, en general, \emph{no} és:
\begin{enumerate}
  \opcio{a}{fidel.}
  \opcio{b}{essencialment exhaustiu (no tot prefeix és representable).}
  \opcio{c}{ple.}
  \opcio{d}{un functor.}
\end{enumerate}
\feedback
